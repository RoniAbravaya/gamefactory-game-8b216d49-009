...
class GameColors {
  ...
  static const Color primary = Color(0xFFF8D800);
  static const Color secondary = Color(0xFFE13D2B);
  static const Color accent = Color(0xFF76B041);
  static const Color success = Color(0xFF3998D8);
  static const Color warning = Color(0xFFFF851B);
